...
def test_fault_tolerance():
    ...
    parser.add_argument("--dht-initial-peers", type=str, default="", help="DHT initial peers")
    parser.add_argument("--dht-port", type=int, default=8000)
    parser.add_argument("--rpc-port", type=int, default=8001)
